...
func (s *service) Create(c context.Context, req Request) (user *User, errorsMap map[string][]string, err error) {
...
func (s *service) Update(c context.Context, req Request, id string) (user *User, errorsMap map[string][]string, err error) {
...
func (s *service) UpdateStatus(c context.Context, req Request, id string) (user *User, errorsMap map[string][]string, err error) {
...
func (s *service) UpdatePassword(c context.Context, req Request, id string) (user *User, errorsMap map[string][]string, err error) {
	errorsMap = map[string][]string{}
	_, err = s.repo.Read(id)
	if err != nil {
		return nil, nil, errors.New("data not found")
...
func (s *service) Index(c context.Context, param ParamIndex) (result *UserIndex, err error) {
	result, err = s.repo.Index(param)
	return
}

func (s *service) Read(c context.Context, id string) (result *User, err error) {
...
func (s *service) RoleIndex(c context.Context) (result []UserRole, err error) {
	result, err = s.repo.RoleIndex()
	return
}

func (s *service) RoleCreate(c context.Context, req RoleRequest) (role *UserRole, errorsMap map[string][]string, err error) {
	errorsMap = map[string][]string{}
	req.Name = strings.TrimSpace(req.Name)
...
func (s *service) RoleUpdate(c context.Context, req RoleRequest, Id string) (role *UserRole, errorsMap map[string][]string, err error) {
	errorsMap = map[string][]string{}
	req.Name = strings.TrimSpace(req.Name)
